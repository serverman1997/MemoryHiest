function send() {
    ...
    var endpointurl="https://script.google.com/macros/s/PkVfbaijxyH-fMW4CFsp4Rc6Mg/exec?func=addData&name="+name+"&phone="+phone+"&email="+email+"&msg="+message+"&subject="+subject;
